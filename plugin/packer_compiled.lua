...
_G.packer_plugins = {
  ...
  ["neovim-ayu"] = {
    loaded = true,
    path = "/Users/nick/.local/share/nvim/site/pack/packer/start/neovim-ayu",
  ...
  ["nvim-dap-ui"] = {
    loaded = true,
    path = "/Users/nick/.local/share/nvim/site/pack/packer/start/nvim-dap-ui",
  ...
  ["todo-comments.nvim"] = {
    loaded = true,
    path = "/Users/nick/.local/share/nvim/site/pack/packer/start/todo-comments.nvim",
  ...
  ["vim-rhubarb"] = {
    loaded = true,
    path = "/Users/nick/.local/share/nvim/site/pack/packer/start/vim-rhubarb",
